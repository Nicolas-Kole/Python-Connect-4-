...
Draw the board grid and empty slots visually on screen
Add chip dropping logic

-Week 2
Implement switching between Player 1 and Player 2 turns
Add full column detection to prevent invalid moves
Implement mouse click input and keyboard controls to select columns 

-Week 3
Implement win detection
Display win message when a player wins
Add logic to stop further moves from being made when a game is finished

-Final Week
Add Player vs CPU mode
Ensure CPU avoids full columns
Add play again feature to restart the game or return to the main menu
